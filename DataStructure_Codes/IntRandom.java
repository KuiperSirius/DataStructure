...
//      int[] table = {85,12,36,24,47,30,53,91,76};
        ...
        Array1.print(table);
//        Array9.insertSort(table);
//        Array9.shellSort(table);
//        Array9.bubbleSort(table);
//        Array9.quickSort(table);
//        Array9.selectSort(table);
//        Array9.heapSort_min(table);
//        Array9.heapSort_max(table);
        Array9.mergeSort(table);
